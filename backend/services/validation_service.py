...
class ValidationService:
    ...
    def _validate_options(self, options: dict) -> None:
        ...
        self._validate_use_ai(options["ai_options"])
    ...
    # Validate title
    # =====================================================
    def _validate_title(self, title, ai_options: dict) -> None:
        ...
        if not title.strip() and not ai_options.get("title", False):
            ...
            raise ValidationError("Title can't be empty without AI option.")
    ...
    def _validate_5w2h(self, methodology) -> None:
        ...
        for field in self.REQUIRED_5W2H_FIELDS:
            ...
            if field not in data:
                logger.error("The '%s' field is missing in 5W2H.", field)
            ...
            if not isinstance(value, str):
                logger.error("The '%s' must be text.", field)
